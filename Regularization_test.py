...
def regularization_experiment(lower, upper, X, reg_mode, n_train=2, components=3):
...
regs1, exp_var_1, hs_1, ws_1 = regularization_experiment(-34, -24, X, 1)
regs2, exp_var_2, hs_2, vs_2 = regularization_experiment(-34, -24, X, 2)
